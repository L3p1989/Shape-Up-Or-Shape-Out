...
Shape.prototype.describe = function() {
  ...
  shapeArea.textContent =
    "area: " +
    parseInt(this.element.style.width) * parseInt(this.element.style.height);
  shapePerim.textContent =
    "perimeter: " +
...
class Rectangle extends Shape {
  constructor() {
    super();
    let rectLength = document.getElementsByClassName("rectangle-width")[0]
      .value;
    let rectHeight = document.getElementsByClassName("rectangle-height")[0]
      .value;
    ...
    this.element.setAttribute(
      ...
      "width: " +
        ...
        rectHeight +
        "px; bottom: " +
        getRndInteger(124, 564) +
        "px; left: " +
        getRndInteger(8, 1045) +
        "px"
    );
  }
}
...
class Circle extends Shape {
  constructor() {
    super();
    let circleRadius = document.getElementsByClassName("circle-radius")[0]
      .value;
    this.element = document.createElement("div");
  ...
  describe() {
    ...
    shapeRadius.textContent =
      "radius: " + parseInt(this.element.style.borderRadius);
    shapePerim.textContent =
      "perimeter: " + 2 * 3.14 * parseInt(this.element.style.borderRadius);
  }
}
...
class Triangle extends Shape {
  ...
  describe() {
    ...
    shapeArea.textContent =
      "area: " +
      0.5 *
        parseInt(this.element.style.borderTop) *
        parseInt(this.element.style.borderTop);
    shapePerim.textContent =
      "perimeter: " +
      (2 * parseInt(this.element.style.borderTop) +
        1.41421356237 * parseInt(this.element.style.borderTop));
  }
}

document
  .getElementsByClassName("rectangle-btn")[0]
  .addEventListener("click", function() {
    ...
    if (
      ...
      document.getElementsByClassName("rectangle-height").value !== ""
    ) {
      addRect();
      document.getElementsByClassName("rectangle-width")[0].value = "";
...
document
  .getElementsByClassName("square-btn")[0]
  .addEventListener("click", function() {
...
document
  .getElementsByClassName("circle-btn")[0]
  .addEventListener("click", function() {
...
document
  .getElementsByClassName("triangle-btn")[0]
  .addEventListener("click", function() {
    let addTri = function() {
